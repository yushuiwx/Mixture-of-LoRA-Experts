        ...
        if from_flax:
            ...
            if low_cpu_mem_usage:
                ...
                if device_map is None:
                    ...
                    #     print(key, state_dict[key].device)
                    # print(">" * 100)
                    # for key in state_dict.keys():
                    #     print(key)
                    ...
                    for key in model.state_dict().keys():
                        if key not in state_dict.keys():
                            state_dict[key] = normalized_columns_initializer(model.state_dict()[key], 0.01)
                            print(model.state_dict()[key].dtype, model.state_dict()[key].device, state_dict[key].device)
