...
class Attention(nn.Module):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, attention_mask=None, gates=None, **cross_attention_kwargs):
...
class AttnProcessor:
    ...
    def __call__(
        ...
        if gates is None:
            ...
            query = attn.to_q(hidden_states, gates)
        ...
        if gates is None:
            ...
            value = attn.to_v(encoder_hidden_states, gates)
